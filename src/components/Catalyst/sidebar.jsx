...
export const SidebarItem = forwardRef(function SidebarItem(
  ...
  let classes = clsx(
    ...
    "data-[slot=icon]:*:size-6 data-[slot=icon]:*:shrink-0 data-[slot=icon]:*:fill-evening-sea-590 sm:data-[slot=icon]:*:size-5",
    ...
    // Active
    "data-[active]:bg-evening-sea-500 data-[slot=icon]:*:data-[active]:fill-evening-sea-950",
    // Current
    "data-[slot=icon]:*:data-[current]:fill-evening-sea-500",
    // Dark mode
    ...
    <span className={clsx(className, "relative")}>
      {current && (
        <motion.span
          ...
          className="absolute inset-y-2 -left-4 w-1 rounded-full bg-evening-sea-500 dark:bg-white"
        />
      )}
      {"href" in props ? (
